 ...
 * (generally physician-issued diagnoses) that have yet to be dismissed. It is a simple list view 
 * that displays notifications by Patient ID number. Clicking on a notification launches the 
 * NotificationViewer.
 */
public class NotificationList extends ListActivity implements SimpleCursorAdapter.ViewBinder {
	private static final String TAG = NotificationList.class.toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = managedQuery(uri, PROJECTION, NotificationSQLFormat.DOWNLOADED + "=1", null, NotificationSQLFormat.DEFAULT_SORT_ORDER);

        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,
                android.R.layout.two_line_list_item, cursor,
                new String[] { NotificationSQLFormat.PATIENT_ID, NotificationSQLFormat.FULL_MESSAGE },
